...
void sample_sort_(slice<InIterator, InIterator> In,
  ...
  if (n < QUICKSORT_THRESHOLD) {
    ...
    // counts[:100] = {0, 12, 8, 26, 18, 12, 8, 5, 13, 8, 10, 10, 17, 17, 15, 4, 12, 14, 10, 16, 10, 11, 11, 14, 7, 5, 11, 12, 17, 17, 9, 11, 11, 12, 12, 8, 16, 8, 6, 15, 19, 16, 19, 21, 21, 16, 21, 11, 9, 21, 12, 14, 19, 8,
    // 8, 11, 12, 12, 11, 19, 19, 6, 14, 15, 15, 18, 10, 15, 5, 13, 8, 16, 14, 7, 9, 14, 17, 9, 17, 8, 11, 9, 11, 18, 6, 9, 8, 11, 10, 15, 9, 7, 14, 8, 37, 14, 16, 9, 12, 10}
    // move data from blocks to buckets
    auto bucket_offsets =
        transpose_buckets<uninitialized_relocate_tag>(Tmp.begin(), Out.begin(), counts, n, block_size,
                                                      num_blocks, num_buckets);
